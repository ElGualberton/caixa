...
?>
<?php $sistema = 'SALVUM - LCTO_CXS_D v1.0.17' ?>
...
<div class="panel-group">
	<div class="panel panel-danger">
		<div class="panel-heading">Deseja Excluir o Lançamento <?php echo $cxsimples_lancamentos['cxs_lcto_id']; ?> do dia <?php echo date_format(date_create($cxsimples_lancamentos['cxs_lcto_dt']), 'd/m/Y');?> ?</div>
		<div class="panel-body">Essa Operação irá excluir do banco de dados do Lançamento <?php echo $cxsimples_lancamentos['cxs_lcto_id']; ?> do dia <?php echo date_format(date_create($cxsimples_lancamentos['cxs_lcto_dt']), 'd/m/Y');?>.</div>
	</div>
</div>
...
<div>
	<div class="col-md-12">
        <a href="delete.php?id=<?php echo $cxsimples_lancamentos['cxs_lcto_id']; ?>&dt=<?php echo $cxsimples_lancamentos['cxs_lcto_dt']; ?>"
