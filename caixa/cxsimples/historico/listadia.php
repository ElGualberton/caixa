...
?>
<?php $sistema = 'SALVUM - HISTO_CXS_DIASELECAO v1.0.17' ?>
	...
	<table class="table table-hover table-condensed">
		...
		<tbody>
			<?php
				...
				WHERE 
					cxs_diario_dt = (SELECT MAX(cxs_diario_dt) from cxsimples_diario where 
					cxs_diario_dt < '" . $_GET['dt'] . "' )";
				//echo $sql;	
					...
					(-1 * 
						(
							...
							where 
								...
								a.cxs_lcto_dt_consolidado = $dia and 
